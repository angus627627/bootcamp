...
public class JavaQuest2 {
  ...
  public static void main(String[] args) {
    ...
    int b = 3 * a % 3; //b=3
    if (a == 9) { //false
      System.out.println("a is equals to 9"); // not exe
    } else if (a < 9 && a >= 0) { //false
      System.out.println("a is between 0 and 8"); // not exe
    } else if (a > 9) {
    ...
    String str = "I love Java. I love coding"; //25
    ...
    if (year1 % 4 == 0 && year1 % 100 != 0 || year1 % 400 == 0) { //false
